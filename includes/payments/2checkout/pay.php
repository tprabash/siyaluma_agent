...
$checkout_seller_id = get_option($config,'checkout_account_number');
$checkout_private_key = get_option($config,'checkout_private_key');
...
if (isset($_SESSION['quickad'][$access_token]['payment_type'])) {
    ...
    try {
        ...
        if ($charge['response']['responseCode'] == 'APPROVED') {
            ...
            $error_msg = $lang['INVALID-TRANSACTION'];
    ...
    error($lang['INVALID-TRANSACTION'], __LINE__, __FILE__, 1);
    exit();
}
