                        ...
                        if($trl_->num_rows > 0){
                            ...
                            while($tru_ca = mysqli_fetch_assoc($trl_)){
                                ...
                                if($tru_ca['start_from'] != 0){
                                    ...
                                    }elseif($_GET['price'] >= $tru_ca['start_from'] && $tru_ca['end_from'] == 0){
                                        if($shellock == false){
                                            $val['price'][]=$tru_ca;
                                            $row['types'][]=$val;
                                            $shellock=true;
                            ...
                            if($shellock == false){
                                foreach ($recal as $key => $value) { 
                                    if($value['start_from'] == 0 && $value['end_from'] == 0){
                                        $val['price'][]=$value;
                                        $row['types'][]=$val;
                                        $shellock=true;
                                    }
...
// Output to template
$page = new HtmlTemplate ('templates/' . $config['tpl_name'] . '/ad-post-test.tpl');
