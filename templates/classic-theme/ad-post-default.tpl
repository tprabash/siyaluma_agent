...
<center><h1> මිළ ගණන් වෙනස් වී ඇත. වැඩි විස්තර සදහා අමතන්න. 0702766942 - April 9th, 2022 </h1></center>
                    ...
                    <div class="col-md-12">
                        ...
                        <header class="PagePostProject-header">
                            ...
                            <div id="ad_post_title">
                                <h1 class="PagePostProject-header-title">{LANG_POST-ADVERTISE}</br></h1>
...
<center><h1> මිළ ගණන් වෙනස් වී ඇත. වැඩි විස්තර සදහා අමතන්න. 0702766942 - 30/09/2021 </h1></center>
