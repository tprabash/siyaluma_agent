    ...
    <div class="container">
        <div class="breadcrumb-section"><!-- breadcrumb -->
            <ol class="breadcrumb">
                ...
                <div class="pull-right back-result"><a href="{LINK_DASHBOARD}"><i class="fa fa-angle-double-left"></i>
                ...
                <div class="section">
                    <div class="user-panel-sidebar">
                        <div class="collapse-box">
                            <h5 class="collapse-title no-border"> {LANG_MY-CLASSIFIED}
                            ...
                            <div id="MyClassified" class="panel-collapse collapse in">
                                <ul class="acc-list">
                                    ...
                                    <li><a href="{LINK_POST-AD}" class="waves-effect"><i class="fa fa-pencil"></i>
                                            {LANG_POST-AD}</a></li>
                                    <li class="active"><a href="{LINK_MEMBERSHIP}" class="waves-effect"><i
                                                    class="fa fa-shopping-bag"></i> {LANG_MEMBERSHIP} </a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="collapse-box">
                            <h5 class="collapse-title"> {LANG_MY-ADS}
                                <a class="pull-right" data-toggle="collapse" href="#MyAds"><i class="fa fa-angle-down"></i></a>
                            </h5>
                        ...
                        <div class="collapse-box">
                            <h5 class="collapse-title no-border"> {LANG_MY-ACCOUNT}
                                <a class="pull-right" data-toggle="collapse" href="#account"><i class="fa fa-angle-down"></i></a>
                            </h5>
