...
<center><h3> මිළ ගණන් වෙනස් වී ඇත. වැඩි විස්තර සදහා අමතන්න. 0702766942 - 30/03/2021 </h3></center>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select class="form-control" id="payment" name="payment" {PAYMENTS.required}>
                                                             ...
                                                             <div id="pboc">
                                                               <p class="help-block">Account Holder: Siyaluma Corporation (PVT)LTD</p>
                                                               <p class="help-block">Account No: 84471330</p>
