                ...
                <div class="">
                    ...
                    <form id="subscribeForm" method="POST" novalidate="novalidate">
                        <div class="payment">
                                ...
                                <div class="payment-tab">
                                    ...
                                    <div class="payment-tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-7 col-md-7">
                                                <div class="card-label form-group">
                                                    <label for="checkoutCardFirstName">{LANG_FIRST-NAME}</label>
                                                    <input
                                                            type="tel"
                                                            class="form-control"
                                                            name="checkoutCardFirstName"
                                                            placeholder="{LANG_FIRST-NAME}"
                                                            required
                                                            />
                                                </div>
                                            </div>
                            ...
                            <!-- eZ Cash Payment Method Check -->
                                IF("{PAYMENT_TYPES.folder}"=="ezcash"){
                                <div class="payment-tab">
                                    <div class="payment-tab-trigger">
                                        <input name="payment_method_id" class="payment_method_id" id="{PAYMENT_TYPES.folder}" type="radio" value="{PAYMENT_TYPES.id}" data-name="ezcash">
                                        <label for="{PAYMENT_TYPES.folder}">{PAYMENT_TYPES.title}</label>
                                        <img class="payment-logo {PAYMENT_TYPES.folder}" src="{SITE_URL}storage/payments/{PAYMENT_TYPES.folder}/logo.png" alt="">
                                    </div>

                                    <div class="payment-tab-content">
                                        <p>For payments done using eZ Cash, use the connection number "0778544700" to transfer money to our account</p>
                                    </div>
                                </div>
...
<script>
    ...
    function payWithStripe()
    {
        ...
        var PublishableKey = '{STRIPE_SECRET_KEY}';
...
<script>
 $(document).ready(function (){
        ...
        $('#subscribeNow').on('click', function (e)
        {
            ...
            if (paymentMethod != 'ezcash' || packagePrice <= 0) {
                return false;
            }
