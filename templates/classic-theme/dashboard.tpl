                      ...
                      <label for="filestyle-0" class="btn btn-outline btn-upload "><span
                              ...
                              class="buttonText">{LANG_CHOOSE-FILE}</span></label>
                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="input-field">
                                            <label for="tagline" class="col-sm-3 control-label active">Tag Line</label>

                                            <div class="col-sm-9">
                                                <input class="form-control border-form" type="text" name="heading"
                                                       id="tagline" value="{AUTHORTAGLINE}">
                                            </div>
                                        </div>
                                        <!--end input-field-->
                                        <div class="input-field">
                                            <label for="tagdescription" class="col-sm-3 control-label active">Tag Description</label>

                                            <div class="col-sm-9">
                                                 <textarea class="form-control border-form" type="text"  name="content">
                                                     {AUTHORABOUT}
                                                 </textarea>        
                                            </div>
                                        </div>
                                        <div class="input-field">
                                            <label for="tagdescription" class="col-sm-3 control-label active">Cover photo</label>
