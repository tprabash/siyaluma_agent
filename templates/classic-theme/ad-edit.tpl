...
<head>
    ...
    <link href="{SITE_URL}templates/{TPL_NAME}/css/post-ad/ModalDeferredLogin.less" type="text/css" rel="stylesheet">
     <link href="{SITE_URL}templates/{TPL_NAME}/css/main.css" type="text/css" rel="stylesheet" />
            ...
            <div class="container">
                ...
                <div class="right-side">
                    <div class="header-widget">
                        ...
                        <a href="{LINK_SIGNUP}" class="sign-in popup-with-zoom-anim"><i class="fa fa-user-plus"></i> {LANG_REGISTER}</a>
                        {:IF}
                                ...
                                <ol>
                                    ...
                                    <li style="padding-bottom: 20px;">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group custom-input-group">
                                                    <input type="text" class="form-control" placeholder="e.g. 987654321" name="phone2" id="phone2" value="{PHONE2}">
                                                </div>
                                                <label class="btn border-left-zero label-adon">
                                                    <input type="checkbox" name="hide_phone2" id="phone2"
                                                           class="FacebookSignUpModal-radio" value="1"
                                                           IF("{HIDEPHONE2}"=="1"){ checked {:IF} >Hide Phone 2
                                                </label>
                                            </div>
                                  ...
                                  name="comments"></textarea>
                                    ...
                                    <li>
                                        ...
                                        <p class="PagePostProject-submit-terms">
                                            {LANG_CLICK-CON}
                                            <a  class="PagePostProject-submit-link" target="_blank" href="#">{LANG_TERM-CON}</a>
                                            {LANG_AND}
                                            <a  class="PagePostProject-submit-link" target="_blank" href="#">{LANG_PRIVACY}</a>
                                            <br>
                                        </p>
                                    </li>
                                </ol>
    ...
    <div class="container">
        <div class="row"><!--About Us-->
            ...
            <div class="col-md-3 col-sm-12">
                ...
                <div class="address">Siyaluma.lk, Mahamaya Road, Matara</div>
               
                <div class="phone"><a href="tel:0472220100">0472220100</a></div>
