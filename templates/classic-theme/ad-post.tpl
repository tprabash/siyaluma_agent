    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#item_screen').orakuploader({
                ...
                orakuploader_thumbnail_size  : 153,
               ...
               <button class="btn btn-primaryy hidden" id="change-city" data-toggle="modal" data-target="#countryModal">Select City</span></button>
                ...
                <div class="right-side">
                    <div class="header-widget">
                        ...
                        <!-- User Menu -->
                        <div class="user-menu">
                            <div class="user-name"><span></span><a href="{SITE_URL}myads">{LANG_MY-ADS}</a></div>
                            <ul>
        ...
        <div class="inner">
            ...
            <div class="modal-content signin text-center">
                ...
                <form action="ajaxlogin" id="lg-form">
                    ...
                    <button id="login" href="#" class="tg-btn">{LANG_LOGIN}</button>
...
<center><h2 style="color:red"> මිළ ගණන් වෙනස් වී ඇත. වැඩි විස්තර සදහා අමතන්න. 0702766942 - October 1st, 2022</h2></center>
                            ...
                            <fl-project-form id="ad_post_form">
                                ...
                                <form class="fl-form" action="{LINK_POST-AD}?action=post_ad" id="post-advertise-form" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    ...
                                    <div class="form-group" style="margin-bottom:50px">
                                        <legend class="PagePostProject-legend">Category *</legend>
                                    ...
                                    <ol>
                                        <li>
                                            <fieldset class="PagePostProject-fieldset">
                                                <legend class="PagePostProject-legend">Title *</legend>
                                                <ol>
                                                    <li class="form-step">
                                    ...
                                    <ol>
                                        <li>
                                            <fieldset class="PagePostProject-fieldset">
                                                <legend class="PagePostProject-legend">Photos *</legend>
                                                <ol>
...
ඉඩමක දැන්විමක් පල කිරිමෙදි ඉඩමේ මුලු වටිනාකම අනුව දැන්වීමේ අය කල යුතු මුදල තීරණය වේ.  Price තීරුවේ ඉඩමේ මුළු වටිනාකම සදහන් කරන්න.  0778544700</div>
                                        ...
                                        <li class="PagePostProject-selectableCard-label only_reg"  id="other_ad_network">
                                            <div class="NumberedForm-content">
                                                ...
                                                <fieldset class="PagePostProject-fieldset">
                                                    ...
                                                    IF("{BLOCKED_MEMBERSHIP}"==""){
                                                        <li class="pay-item" id="is_guess">
                                                            <input type="radio" class="pay-check" name="network_option" id="ikmanPkg" value="ikmanPkg">
                                                            <label class="pay-check-label" for="ikmanPkg">
                                                                <img src="{SITE_URL}templates/{TPL_NAME}/images/packages/ikman.jpg" alt="ikman.lk">
                                                            </label>
                                                            
                                                            <ul class="list-group" id="ikmanPkg" style="display:none">
                                                              <li class="list-group-item">ikman</li>
                                                    ...
                                                    {:IF}
                                                     <!--Budget Vehicle-->
                                                    <li class="pay-item">
                                                        <input type="radio" class="pay-check" name="network_option" id="budgetwebsites" value="budgetwebsites">
                                                        <label class="pay-check-label" for="budgetwebsites">
                                                          <img src="{SITE_URL}templates/{TPL_NAME}/images/packages/budget.jpg" alt="Budget Websites">
                                                        </label>
                                                        
                                                        <ul class="list-group" id="budgetwebsites" style="display:none">
                                                          <li class="list-group-item">Siyaluma.lk</li>
                                                          <li class="list-group-item">5 Websites</li>
                                                          <li class="list-group-item">
                                                              <span class="label label-success">Customer</span> Rs. 800
                                                              <input type="hidden" name="budgetwebsitesPrice" value="800">
                                                          </li>
                                                          <li class="list-group-item" id="is_guess">
                                                             <span class="label label-primary">Agent</span> Rs. 300
                                                          </li>
                                                        </ul>
                                                    </li>
                                                    <!--Lankadeepa-->
                                                    <li class="pay-item">
                                                        <input type="radio" class="pay-check" name="network_option"  id="lankadeepa" value="lankadeepa">
                                                        <label class="pay-check-label" for="lankadeepa">
                                                            <img src="{SITE_URL}templates/{TPL_NAME}/images/packages/lahipita.png" alt="irida Lankadeepa">
                                                        </label>
                                                        <ul class="list-group" id="lankadeepa" style="display:none">
                                                          <li class="list-group-item">Irida Lankadeepa</li>
                                                          <li class="list-group-item">4 Websites</li>
                                                          <li class="list-group-item">
                                                              <span class="label label-success">Customer</span> Rs. 2000 
                                                               <input type="hidden" name="lankadeepaPrice" value="2000">
                                                          </li>
                                                          <li class="list-group-item"  id="is_guess">
                                                             <span class="label label-primary">Agent</span> Rs. 1500 
                                                          </li>
                                                        </ul>
                                                    </li>
                                                    <!--Sunday Times Hitad-->
                                                    <li class="pay-item">
                                                        <input type="radio" class="pay-check" name="network_option"  id="sundaytimeshitad" value="sundaytimeshitad">
                                                        <label class="pay-check-label" for="sundaytimeshitad">
                                                            <img src="{SITE_URL}templates/{TPL_NAME}/images/packages/times.jpg" alt="Sunday Times Hitad">
                                                        </label>
                                                        <ul class="list-group" id="sundaytimeshitad" style="display:none">
                                                          <li class="list-group-item">SundayTimes HidAd</li>
                                                          <li class="list-group-item">4 Websites</li>
                                                          <li class="list-group-item">
                                                              <span class="label label-success">Customer</span> Rs. 1000 
                                                              <input type="hidden" name="sundaytimeshitadPrice" value="1000">
                                                          </li>
                                                          <li class="list-group-item"  id="is_guess">
                                                             <span class="label label-primary">Agent</span> Rs. 700 
                                                          </li>
                                                        </ul>
                                                    </li>
                                                    <!--Silumina-->
                                                    <li class="pay-item">
                                                        <input type="radio" class="pay-check" name="network_option" id="silumina" value="silumina">
                                                        <label class="pay-check-label" for="silumina">
                                                            <img src="{SITE_URL}templates/{TPL_NAME}/images/packages/silumina-top.jpg" alt="Silumina">
                                                        </label>
                                                        <ul class="list-group" id="silumina" style="display:none">
                                                          <li class="list-group-item">Silumina Newspaper</li>
                                                          <li class="list-group-item">4 Websites</li>
                                                          <li class="list-group-item">
                                                              <span class="label label-success">Customer</span> Rs.1000 
                                                               <input type="hidden" name="siluminaPrice" value="1000">
                                                          </li>
                                                          <li class="list-group-item"  id="is_guess">
                                                             <span class="label label-primary">Agent</span> Rs. 700 
                                                          </li>                        
                                                    ...
                                                    <!--Sunday Observer-->
                                                    <li class="pay-item">
                                                        <input type="radio" class="pay-check" name="network_option" id="sundayobserver" value="sundayobserver">
                                                        <label class="pay-check-label" for="sundayobserver">
                                                           <img src="{SITE_URL}templates/{TPL_NAME}/images/packages/sunday-observer.png" alt="Sunday Observer">
                                                        </label>
                                                        <ul class="list-group" id="sundayobserver" style="display:none">
                                                          <li class="list-group-item">Sunday Observer</li>
                                                          <li class="list-group-item">4 Websites</li>
                                                          <li class="list-group-item">
                                                              <span class="label label-success">Customer</span> Rs.1000 
                                                              <input type="hidden" name="sundayobserverPrice" value="1000">
                                                          </li>
                                                          <li class="list-group-item"  id="is_guess">
                                                             <span class="label label-primary">Agent</span> Rs. 700 
                                                          </li>                        
                                                    ...
                                                    <li class="pay-item">
                                                        <input type="radio" class="pay-check" name="network_option" id="facebookad" value="facebookad">
                                                        <label class="pay-check-label" for="facebookad">
                                                             <img src="{SITE_URL}templates/{TPL_NAME}/images/packages/facebook.jpg" alt="facebookad">
                                                        </label>
                                                        <ul class="list-group" id="facebookad" style="display:none">
                                                          <li class="list-group-item">40,000 facebook views</li>
                                                          <li class="list-group-item">4 Websites</li>
                                                          <li class="list-group-item">
                                                              <span class="label label-success">Customer</span> Rs. 1500  
                                                               <input type="hidden" name="facebookadPrice" value="1500">
                                                          </li>
                                                          <li class="list-group-item"  id="is_guess">
                                                             <span class="label label-primary">Agent</span> Rs. 1000  
                                                          </li> 
                                                        </ul>
                                                    </li>
                                                    
                                                     IF("{SHOWTRANSACTION}"=="0"){
                                                        <input type="hidden" name="is_free_user" value="1">
                                                     {:IF}
                                                     
                                                     IF("{SHOWTRANSACTION}"!="0"){
                                                        <input type="hidden" name="is_free_user" value="0">
                                                     {:IF}
