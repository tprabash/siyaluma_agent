                        ...
                        <div class="form-body">
                            ...
                            if($folder == "2checkout"){
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="checkout_account_number" type="text" class="form-control" placeholder="Enter your 2Checkout Account Number" value="<?php echo get_option($config,'checkout_account_number')?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Publishable Key:</label>
                                    <div class="col-sm-6">
                                        <input name="checkout_public_key" type="text" class="form-control" placeholder="Enter your 2Checkout Publishable Key." value="<?php echo get_option($config,'checkout_public_key')?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Private API Key:</label>
                                    <div class="col-sm-6">
                                        <input name="checkout_private_key" type="password" class="form-control" placeholder="Enter your 2Checkout Private Key" value="<?php echo get_option($config,'checkout_private_key')?>">
                                    </div>
                                </div>
                            <?php
                            }
