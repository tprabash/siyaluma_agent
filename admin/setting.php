                                                    ...
                                                    <div class="tab-pane active" id="quickad_settings_general">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_settings_general">
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input name="site_url" class="form-control" type="Text" id="site_url" value="<?php echo get_option( $config, "site_url"); ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="delete_expired" id="delete_expired" class="form-control">
                                                                    <option value="1" <?php if(get_option( $config, "delete_expired") == '1'){ echo "selected"; } ?>>Yes Delete</option>
                                                                    <option value="0" <?php if(get_option( $config, "delete_expired") == '0'){ echo "selected"; } ?>>No</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <p class="help-block">Please enter time in seconds for example: 60 = 1 minutes<br>
                                                                    3600 = 1 Hour.</p>
                                                                <input name="cron_exec_time" class="form-control" type="text" id="cron_exec_time" value="<?php echo get_option( $config, "cron_exec_time"); ?>">
                                                            </div>
                                                        ...
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_theme_setting">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="contact_validation" id="contact_validation" class="form-control">
                                                                    <option value="1" <?php if(get_option( $config, "contact_validation") == '1'){ echo "selected"; } ?>>Show Logged User</option>
                                                                    <option value="0" <?php if(get_option( $config, "contact_validation") == '0'){ echo "selected"; } ?>>Show Publicly</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="tab-pane" id="quickad_frontend_submission">
                                                        <form method="post" action="ajax_sidepanel.php?action=SaveSettings" id="#quickad_frontend_submission">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <select name="post_without_login" class="form-control">
                                                                        <option <?php if(get_option( $config, "post_without_login") == '1'){ echo "selected"; } ?> value="1">
                                                                            Enable (User can post without login.)
                                                                        </option>
                                                                        <option <?php if(get_option( $config, "post_without_login") == '0'){ echo "selected"; } ?> value="0">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    <input name="termcondition_link" type="text" class="form-control" value="<?php echo get_option( $config, "termcondition_link"); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Privacy Page Link:</label>
                                                                <div>
                                                                    <input name="privacy_link" type="text" class="form-control" value="<?php echo get_option( $config, "privacy_link"); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="panel-footer">
