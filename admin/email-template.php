                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <textarea name="email_message_editor_signup_details" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_signup_details") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_signup_confirm" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_signup_confirm") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_forgot_pass" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_forgot_pass") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_contact" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_contact") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_feedback" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_feedback") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_report" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_report") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_ad_approve" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_ad_approve") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_re_ad_approve" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_re_ad_approve") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-0" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_contact_seller" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_contact_seller") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label>Subject</label>
                                                                                        <input name="email_sub_post_notification" placeholder="Email Subject" class="form-control" type="text" value="<?php echo get_option( $config, "email_sub_post_notification") ?>">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-9" <?php if($config['email_template'] != '0'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_editor_post_notification" rows="6" class="form-control summernote" placeholder="Enter Message"><?php echo get_option( $config, "email_message_post_notification") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-9" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_post_notification" rows="10" class="form-control" placeholder="Enter Message"><?php echo get_option( $config, "email_message_post_notification") ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                    ...
                    <div id="quickad-tbs">
                        <div class="btn-group quickad-margin-bottom-lg quickad-services-holder">
                            ...
                            <ul class="dropdown-menu" style="width: 570px">
                                ...
                                <li class="quickad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success"  href="#">
                                        <input type="checkbox" class="quickad-js-check-entity" value="any" id="postad_newsletter" name="postad_newsletter">
                                        <label for="postad_newsletter">	Send new ad notification to subscriber</label>
                                    </a>
                                </li>
                            </ul>
                        </div>
